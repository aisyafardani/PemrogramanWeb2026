...
- Tambah `data/buku.json` (10 objek) dan `data/anggota.json` (5 objek) sebagai pengganti sementara API sungguhan.
...
Link Laporan Praktikum: https://docs.google.com/document/d/1AsV7vTPtoZK56zssUOeioJzPT3uU4lhN/edit